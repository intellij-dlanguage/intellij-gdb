...
public class GdbEvaluator extends XDebuggerEvaluator {
     ...
     */
    @Override
    public void evaluate(@NotNull String expression, final XEvaluationCallback callback, @Nullable XSourcePosition expressionPosition) {
        m_gdb.evaluateExpression(m_thread, m_frame, expression, event -> onGdbExpressionReady(event, callback));
    }
